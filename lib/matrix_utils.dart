...
class MatrixUtils {
  ...
  static void frustum(Float32List matrix, double left, double right,
  ...
  static void setLookAt(Float32List matrix,
...
/*
  /// Multiplies two matrices: result = lhs * rhs
...
static void multiplyMM(
  ...
  static void rotate(Float32List matrix, double angleDegrees, double x, double y, double z) {
    ...
    multiplyMM(matrix, matrix, rotMatrix);
  }
  ...
  static List<double> transformPoint(Float32List matrix, double x, double y, double z) {
  ...
  static void multiplyMV(Float32List result, Float32List matrix, Float32List vector) {
